...
public class ChartController {
    ...
    public ResponseEntity<ChartResponseDto> chartDetail(@PathVariable String ticker)
            throws Exception {
        log.info("ticker number : {}" , ticker);
        return ResponseEntity.ok(chartService.getChart(ticker));
    }
}
